/* this do file amends some of the default values and checks that there are at least 20 distinct values per 
   instance in each field for those observations with two non missing instances and removes those that don't */
...
use $RESULTS/used_vars_list.dta
...
/* also that there are at least 100 observations with repeats */
ds
...
forvalues vnum=2(2)`numvars' {
   ...
   drop tag0 tag1 include
   macro drop n dcount0 dcount1 fnum
}
