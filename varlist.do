...
*exclusion 5 - manually identified exclusions
   ...
   replace excl=5 if inlist(fieldid,5983,5984,5986,5992,5993,396,397,398,399,400,403,404,20082)
   replace excl=5 if inlist(fieldid,20006,20008,20009,20010,20011,40007,40008)
