/* bootmodels3 - creates 3rd 1,000 bootstrap replicates for the regression calibration */
/* Requires - modelfile_comp.dta */
/* Main output - boots_3.dta */
...
*Model 3 - regression calibrated model with correction for crp and smoking and bmi
  ...
  simulate corre_all=r(corre_all) correc_all=r(correc_all) ///
	...
	, reps(1000) nodots seed(48357) saving(boots_3.dta, replace) : mybootbris1
