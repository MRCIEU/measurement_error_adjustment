/* concord_23.do - Run concordance analysis and get ICC for all records */
/* Requires - finalfile23a.dta, finalfile23b.dta, finalfile23c.dta and used_vars_list23.dta */
/* Main output - concordance_output23.dta, concordance_output.xlsx */

/* Do file to run concordance analysis and get ICC for all records */

/* need finalfile_23.dta */
...
*put output to file
   postfile results fieldid numdiff med_assess_tm p25_assess_tm p75_assess_tm med_diet_tm p25_diet_tm p75_diet_tm ///
                   ...
                   icc icc_cill icc_ciul lamda_p var_lamda_p var_inv_lamda_p using concordance_output23`f'.dta, replace
...
*combine the part datasets into one
 use concordance_output23a.dta, clear
 append using concordance_output23b
 append using concordance_output23c
 save concordance_output23.dta, replace

*get extra information about each variable from original variable list
 use used_vars_list23.dta, clear
 keep fieldid field category instances 
 order fieldid field category
 sort fieldid
 merge 1:1 fieldid using concordance_output23.dta, nogen keep(match using)
...
*create high category for graphs 
 ...
 order fieldid field short_name category highcat instances numdiff mth_diff_median mth_diff_iqr ///
       ...
       lamda_p var_lamda_p var_inv_lamda_p icc_cill icc_ciul asym_ll asym_ul
...
*output to excel sheet
 export excel "$RESULTS/concordance_output.xlsx", sheet("Imaging visit") firstrow(varlabels) sheetreplace
