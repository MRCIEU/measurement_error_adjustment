...
foreach f in a b c {
  ...
  *run for each variable in both instances (excluding eid and dates)
  forvalues pos = 8(2)`numvars' {
    ...
    *get icc from as much data as is available but need long format
    quietly reshape long field,  i(eid)
  
    quietly icc field eid
    local icc=r(icc_i)
...
label define categories 1 "Anthropometry" 2 "Eye measures" 3 "Physical measures" ///
      ...
      7 "Medical history" 8 "Lifestyle" 9 "Metabolomics" 10 "DXA assessment" ///
