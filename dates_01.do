/* dates_01.do - Add the diet date field that is in a separate file and rename and reformat the date fields */
/* Requires - mainfile01.dta, new_dates_data.csv */
...
*get main data and merge on extra dates
