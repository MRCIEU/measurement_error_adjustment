...
capture program drop mybootbris3
program define mybootbris3, rclass
...
simulate corre_all=r(corre_all) correc_all=r(correc_all) ///
	...
	, reps(1000) nodots seed(83477) saving(boots_3a.dta, replace) : mybootbris3

simulate corre_all=r(corre_all) correc_all=r(correc_all) ///
        corre_cvd=r(corre_cvd) correc_cvd=r(correc_cvd) ///
        corre_cancer=r(corre_cancer) correc_cancer=r(correc_cancer) ///
        , reps(1000) nodots seed(12454) saving(boots_3b.dta, replace) : mybootbris3
